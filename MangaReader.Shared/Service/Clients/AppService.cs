using MangaReader.Shared.Service.Response;
using MangaReader.Shared.Utils;

namespace MangaReader.Shared.Service;
public class AppService : BaseService
{
    ...
    public string UrLBase = Constants.apiPathScans;
